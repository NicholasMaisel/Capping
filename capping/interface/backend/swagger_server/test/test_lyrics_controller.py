...
class TestLyricsController(BaseTestCase):
    ...
    def test_lyrics_filter_get(self):
        """Test case for lyrics_filter_get
        ...
        response = self.client.open(
            '/NicholasMaisel/MusicCapping/1.0.0/lyrics/filter',
            method='GET',
    ...
    def test_lyrics_get(self):
        """Test case for lyrics_get

        Get all lyrics
        """
        response = self.client.open(
            '/NicholasMaisel/MusicCapping/1.0.0/lyrics',
            method='GET',
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
