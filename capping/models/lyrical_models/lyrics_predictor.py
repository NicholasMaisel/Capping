...
model = load('saved_lyrical_model.joblib')
transformer = load('transformer.bin')
vectorizer = load('vectorizer.bin')
...
print(model.predict(song_genre_predictor(artist='Lil Baby', song='Emotionally Scarred')))
